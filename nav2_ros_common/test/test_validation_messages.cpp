...
TEST(ValidateMessagesTest, DoubleValueCheck) {
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(3.14));
  // Test invalid double value (infinity)
  EXPECT_FALSE(nav2_ros_common::validateMsg(std::numeric_limits<double>::infinity()));
  // Test invalid double value (NaN)
  EXPECT_FALSE(nav2_ros_common::validateMsg(std::numeric_limits<double>::quiet_NaN()));
}
...
TEST(ValidateMessagesTest, TimeStampCheck)
{
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(valid_time_stamp));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalid_time_stamp));
}
...
TEST(ValidateMessagesTest, HeaderCheck)
{
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(valid_header));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalid_header));
  invalid_header.stamp.sec = 123;
...
TEST(ValidateMessagesTest, PointCheck)
{
  ...
  valid_point.y = 2.0;
  valid_point.z = 3.0;
  EXPECT_TRUE(nav2_ros_common::validateMsg(valid_point));
  ...
  invalid_point.z = 3.0;
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalid_point));
  // Test invalid Point message with NaN value
...
TEST(ValidateMessagesTest, QuaternionCheck)
{
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(valid_quaternion));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalid_quaternion));
...
TEST(ValidateMessagesTest, PoseCheck)
{
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(valid_pose));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalid_pose));
...
TEST(ValidateMessagesTest, MapMetaDataCheck) {
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(valid_map_meta_data));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalid_map_meta_data));
...
TEST(ValidateMessagesTest, OccupancyGridCheck) {
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(valid_occupancy_grid));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalid_occupancy_grid));
...
TEST(ValidateMessagesTest, PoseWithCovarianceCheck) {
  ...
  EXPECT_TRUE(nav2_ros_common::validateMsg(validate_msg));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalidate_msg1));
  ...
  EXPECT_FALSE(nav2_ros_common::validateMsg(invalidate_msg2));
}
