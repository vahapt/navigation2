...
protected:
  ...
  nav2::ServiceServer<nav_msgs::srv::GetMap,
    nav2::LifecycleNode::SharedPtr>::SharedPtr occ_service_;

  // A service to load the occupancy grid from file at run time (LoadMap)
  nav2::ServiceServer<nav2_msgs::srv::LoadMap,
    nav2::LifecycleNode::SharedPtr>::SharedPtr load_map_service_;
